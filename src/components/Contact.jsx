        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <h3 className="text-zinc-300 mt-3 mb-8 reveal-up">
                    Email: <a  href="mailto: sgoyal3@buffalo.edu">sgoyal3@buffalo.edu</a>
                    </h3>
                ...
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" placeholder="Your Message" required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                    </div>
