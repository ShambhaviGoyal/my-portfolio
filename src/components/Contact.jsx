...
const socialLinks = [
    ...
    {
      href: 'www.linkedin.com/in/shambhavigoyal',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return(
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                {/* FORM SUBMISSION  */}
                <form action="https://getform.io/f/aolmdlqb"
                method="POST"                
                className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Shambhavi Goyal" className="text-field"/>
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="shambhavi@example.com" className="text-field"/>
                        </div>
